 ...
 */
CurvePoint::CurvePoint(Point point, float drive_voltage, float turn_voltage, float follow_distance, float drive_settle_error, float point_length, float slow_down_turn_radians, float slow_down_turn_amount) :
  x(point.x),
  y(point.y),
